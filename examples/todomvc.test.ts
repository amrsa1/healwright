...
test.describe('healwright - AI-Only Mode', () => {
  ...
  test('should complete a todo using AI detection', async ({ page }) => {
    // Add a todo first using regular Playwright
    await page.locator('.new-todo').fill('Learn healwright');
    await page.keyboard.press('Enter');
  ...
  test('should delete a todo using AI detection', async ({ page }) => {
    ...
    await page.heal.click('', 'Button to delete or remove the todo item');
